...
for t=1:finT
    car1_x(t+1,1) = car1_x(t,1) + car1_vx1;
    car1_x(t+1,2) = car1_x(t,2) + car1_vx2*sin(car1_omega*t);

    car2_x(t+1,1) = car2_x(t,1) + car2_vx1;
    car2_x(t+1,2) = car2_x(t,2) + car2_vx2*sin(car2_omega*t);
end
